...
begin
   ...
   var triples  :=  group_by_triples( sl );                                        //  *

   var common2  :=  UFP.List_Map <tri_type, char>  (triples, find_common2);        //  * Map (rucksacks, find_common)

       priority :=  UFP.List_Map <char, integer>   (common2, calc_priority );      //  Map (common, calc_priority)
